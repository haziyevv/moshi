...
def get_qwen_moshi_lm(
    ...
    """Create a Moshi LMModel with a Qwen 2.5 backbone (3B, 7B, etc.).
    ...
    Args:
        qwen_weights: Path to a safetensors file — either converted Qwen backbone
            weights or a full fine-tuned checkpoint.
    ...
    # Scale audio embeddings near zero so backbone input starts as mostly text_emb
    # (which Qwen understands). Only for fresh Qwen weights — skip for fully trained.
